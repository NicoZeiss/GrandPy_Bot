...
_STOP_WORDS = ["", "bonjour", "trouve", "grandpy", "salut", "bot", "grandpybot", "salutations", "salutation", "hello", "hi", "coucou", "papy", "papie", "robot", "grand", "py", "sage"]


# GM API -------------------------------------------------------------------------

GM_URL = 'https://maps.googleapis.com/maps/api/place/findplacefromtext/json'
...
"err_input": {"1": "Moi pas comprendre toi ! Toi être plus concis avec moi !"},
"err_place": {"1": "Désolé bel internaute, mais il va falloir être un peu plus précis, je ne trouve pas le lieu auquel tu fais référence !"},
